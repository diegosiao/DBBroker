...
CREATE USER DBBROKER IDENTIFIED BY dbbroker1! DEFAULT TABLESPACE users TEMPORARY TABLESPACE temp;
...
-- Create the tables
CREATE TABLE DBBROKER.CUSTOMERS (
...
CREATE TABLE DBBROKER.CUSTOMERS_NOTES_STATUS (
    ID NUMBER PRIMARY KEY,
    STATUS VARCHAR2(50)
);

CREATE TABLE DBBROKER.CUSTOMERS_NOTES (
    ID RAW(16) PRIMARY KEY,
    CUSTOMER_ID RAW(16),
    STATUS_ID NUMBER,
...
CREATE TABLE DBBROKER.ORDER_STATUS (
    ID NUMBER PRIMARY KEY,
    STATUS VARCHAR2(50) NOT NULL
);

CREATE TABLE DBBROKER.ORDERS (
    ID RAW(16) PRIMARY KEY,
...
CREATE TABLE DBBROKER.ORDERS_NOTES (
    ID NUMBER PRIMARY KEY,
    NOTE_CONTENT VARCHAR2(1024) NOT NULL
);

CREATE TABLE DBBROKER.PRODUCTS (
    ID RAW(16) PRIMARY KEY,
    PRODUCT_NAME VARCHAR2(50) NOT NULL
);

CREATE TABLE DBBROKER.ORDERS_PRODUCTS (
    ID RAW(16) PRIMARY KEY,
...
CREATE TABLE DBBROKER.PROMOTIONS (
    ID NUMBER PRIMARY KEY,
    TITLE VARCHAR2(50) NOT NULL,
    EXPIRATION TIMESTAMP NOT NULL
);

CREATE TABLE DBBROKER.PROMOTIONS_ENROLLMENTS (
    ID NUMBER PRIMARY KEY,
    CUSTOMER_ID RAW(16) NOT NULL,
...
INSERT INTO DBBROKER.ORDER_STATUS(ID, STATUS)
VALUES(DBBROKER.ORDERS_NOTES_SEQ.nextval, 'New');

INSERT INTO DBBROKER.ORDER_STATUS(ID, STATUS)
VALUES(DBBROKER.ORDERS_NOTES_SEQ.nextval, 'Pending');

INSERT INTO DBBROKER.ORDER_STATUS(ID, STATUS)
VALUES(DBBROKER.ORDERS_NOTES_SEQ.nextval, 'Finished');

INSERT INTO DBBROKER.ORDER_STATUS(ID, STATUS)
VALUES(DBBROKER.ORDERS_NOTES_SEQ.nextval, 'Canceled');
